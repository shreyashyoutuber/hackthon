...
// // 6. Test Route
// app.get('/', (req, res) => {
//     // Now we can just send the main index.html file as the homepage
...
// // --- UPDATE STUDENT DATA (for Teacher) ---
// app.post('/update-student-data', (req, res) => {
...
//             console.log('Database saved to file with updates.');
//             res.json({ success: true, message: 'Student updated successfully!' });
//         } catch (error) {
//             console.error('Failed to save database:', error);
//             res.json({ success: false, message: 'Failed to save updates.' });
//         }
//     } else {
...
//     try {
//         fs.writeFileSync('database.json', JSON.stringify(mockUserDatabase, null, 2));
//         console.log('New student added and database saved.');
//         res.json({ success: true, message: 'New student created successfully!' });
//     } catch (error) {
//         console.error('Failed to save database:', error);
//         res.json({ success: false, message: 'Failed to save new student to database.' });
//     }
// });
...
//         // --- *** THIS IS THE UPDATED EMAIL CODE (OPTION 2) *** ---
//         const mailOptions = {
...
// // STEP 3: Set the password and create the user
